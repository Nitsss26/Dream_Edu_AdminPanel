...
const AboutForm1: React.FC<AboutFormProps> = ({ initialData }) => {
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            ...
            if (res.ok) {
                setLoading(false);
                toast.success(`About ${initialData ? "updated" : "created"}`);
                window.location.href = "/about";
                router.push("/about");
            }
        } catch (err) {
            console.log("[about_POST]", err);
        ...
        <div className="p-10">
            {initialData ? (
                <div className="flex items-center justify-between">
                    <p className="text-heading2-bold">Edit About</p>
                    {/* <Delete id={initialData._id} item="about" /> */}
                </div>
            ) : (
                <p className="text-heading2-bold">About</p>
            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex-1">
                                    ...
                                    <FormControl>
                                        <Input placeholder="" {...field} onKeyDown={handleKeyPress} className="custom-border" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel>Name</FormLabel>
                                <FormControl>
                                    <Textarea placeholder="Name" {...field} rows={1} onKeyDown={handleKeyPress} className="custom-border" />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                {/* <FormLabel>Name</FormLabel> */}
                                <FormControl>
                                    <Textarea placeholder="Description" {...field} rows={1} onKeyDown={handleKeyPress} className="custom-border" />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                    />
                    {/* <div className="text-center font-bold -ms-10">Features</div> */}
                    <div className="flex space-x-4">
                        <FormField
                            control={form.control}
                            name="field7"
