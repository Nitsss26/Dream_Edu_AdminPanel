...
const formSchema = z.object({
    ...
    description4: z.string().max(1000).optional(),
    description5: z.string().max(1000).optional(),
    description6: z.string().max(1000).optional(),
    description7: z.string().max(1000).optional(),
    description8: z.string().max(1000).optional(),
    description9: z.string().max(1000).optional(),
    description10: z.string().max(1000).optional(),
    ...
    field5: z.string().max(1000).optional(),
    field6: z.string().max(1000).optional(),
    field7: z.string().max(1000).optional(),
    field8: z.string().max(1000).optional(),
    field9: z.string().max(1000).optional(),
    field10: z.string().max(1000).optional(),
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            ...
            const url = initialData
                ? `/api/test-creation/${initialData._id}`
                : "/api/test-creation";
            ...
            if (res.ok) {
                setLoading(false);
                toast.success(`Test-Creation ${initialData ? "updated" : "created"}`);
                window.location.href = "/test-creation";
                router.push("/test-creation");
            }
        } catch (err) {
            console.log("[test-creation_POST]", err);
        ...
        <div className="p-10">
            {initialData ? (
                <div className="flex items-center justify-between">
                    <p className="text-heading2-bold">Edit Test-Creation</p>
                    {/* <Delete id={initialData._id} item="test-creation" /> */}
                </div>
            ) : (
