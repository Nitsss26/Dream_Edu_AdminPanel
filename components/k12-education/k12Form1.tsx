...
const formSchema = z.object({
    ...
    field12: z.string().max(500).optional(),
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            ...
            const url = initialData
                ? `/api/k12-education/${initialData._id}`
                : "/api/k12-education";
            ...
            if (res.ok) {
                setLoading(false);
                toast.success(`K12-education ${initialData ? "updated" : "created"}`);
                window.location.href = "/k12-education";
                router.push("/k12-education");
            }
        } catch (err) {
            console.log("[k12-education_POST]", err);
        ...
        <div className="p-10">
            {initialData ? (
                <div className="flex items-center justify-between">
                    <p className="text-heading2-bold">Edit K12-education</p>
                    {/* <Delete id={initialData._id} item="k12-education" /> */}
                </div>
            ) : (
                <p className="text-heading2-bold">K12-education</p>
            )}
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 font-semibold">
                    ...
                    <div className="flex gap-10">
                        ...
                        <Button
                            type="button"
                            onClick={() => router.push("/k12-education")}
