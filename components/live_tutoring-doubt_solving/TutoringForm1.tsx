    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            ...
            const url = initialData
                ? `/api/live_tutoring-doubt_solving/${initialData._id}`
                : "/api/live_tutoring-doubt_solving";
            ...
            if (res.ok) {
                setLoading(false);
                toast.success(`Live_tutoring-doubt_solving ${initialData ? "updated" : "created"}`);
                window.location.href = "/live_tutoring-doubt_solving";
                router.push("/live_tutoring-doubt_solving");
            }
        } catch (err) {
            console.log("[live_tutoring-doubt_solving_POST]", err);
        ...
        <div className="p-10">
            {initialData ? (
                <div className="flex items-center justify-between">
                    <p className="text-heading2-bold">Edit Live Tutoring-Doubt Solving</p>
                    {/* <Delete id={initialData._id} item="live_tutoring-doubt_solving" /> */}
                </div>
            ) : (
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 font-semibold">
                    ...
                    <div className="flex gap-10">
                        ...
                        <Button
                            type="button"
                            onClick={() => router.push("/live_tutoring-doubt_solving")}
