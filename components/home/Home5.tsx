...
const Home5: React.FC<AboutFormProps> = ({ initialData }) => {
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            ...
            if (res.ok) {
                setLoading(false);
                toast.success(`Home ${initialData ? "updated" : "created"}`);
        ...
        <div className="p-10">
            {initialData ? (
                <div className="flex items-center justify-between">
                    <p className="text-heading2-bold">Edit Home</p>
                    {/* <Delete id={initialData._id} item="home" /> */}
                </div>
            ) : (
