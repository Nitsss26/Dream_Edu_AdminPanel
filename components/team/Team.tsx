...
const formSchema = z.object({
    ...
    description4: z.string().max(5000).optional(),
    description5: z.string().max(5000).optional(),
    description6: z.string().max(5000).optional(),
    description7: z.string().max(5000).optional(),
    description8: z.string().max(5000).optional(),
    description9: z.string().max(5000).optional(),
    description10: z.string().max(5000).optional(),
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 font-semibold">
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormControl>
                                    <Textarea placeholder="Description" {...field} rows={2} onKeyDown={handleKeyPress} className="custom-border" />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex-1">
                                    <FormLabel>Name</FormLabel>
                                    <FormControl>
                                        <Input placeholder="Field 10" {...field} onKeyDown={handleKeyPress} className="custom-border" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex-1">
                                    <FormLabel>Designation</FormLabel>
                                    <FormControl>
                                        <Input placeholder="Field 11" {...field} onKeyDown={handleKeyPress} className="custom-border" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex-1">
                                    <FormLabel>Name</FormLabel>
                                    <FormControl>
                                        <Input placeholder="Field 12" {...field} onKeyDown={handleKeyPress} className="custom-border" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex-1">
                                    <FormLabel>Designation</FormLabel>
                                    <FormControl>
                                        <Input placeholder="Field 13" {...field} onKeyDown={handleKeyPress} className="custom-border" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex-1">
                                    <FormLabel>Name</FormLabel>
                                    <FormControl>
                                        <Input placeholder="Field 14" {...field} onKeyDown={handleKeyPress} className="custom-border" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex-1">
                                    <FormLabel>Designation</FormLabel>
                                    <FormControl>
                                        <Input placeholder="Field 15" {...field} onKeyDown={handleKeyPress} className="custom-border" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex-1">
                                    <FormLabel>Name</FormLabel>
                                    <FormControl>
                                        <Input placeholder="Input" {...field} onKeyDown={handleKeyPress} className="custom-border" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
