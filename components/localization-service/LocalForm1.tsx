    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            ...
            const url = initialData
                ? `/api/localization-service/${initialData._id}`
            ...
            if (res.ok) {
                setLoading(false);
                toast.success(`Localization-Service ${initialData ? "updated" : "created"}`);
                window.location.href = "/localization-service";
                router.push("/localization-service");
            }
        } catch (err) {
            console.log("[localization-service_POST]", err);
        ...
        <div className="p-10">
            {initialData ? (
                <div className="flex items-center justify-between">
                    <p className="text-heading2-bold">Edit Localization-Service</p>
                    {/* <Delete id={initialData._id} item="localization-service" /> */}
                </div>
            ) : (
                <p className="text-heading2-bold">Loca lization-Service</p>
            )}
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 font-semibold">
                    ...
                    <div className="flex gap-10">
                        ...
                        <Button
                            type="button"
                            onClick={() => router.push("/localization-service")}
