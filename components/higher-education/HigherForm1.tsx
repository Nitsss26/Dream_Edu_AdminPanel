...
const formSchema = z.object({
    ...
    field15: z.string().max(5000).optional(),
    field16: z.string().max(5000).optional(),
    field17: z.string().max(5000).optional(),
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            ...
            const url = initialData
                ? `/api/higher-education/${initialData._id}`
                : "/api/higher-education";
            ...
            if (res.ok) {
                setLoading(false);
                toast.success(`Higher-Education ${initialData ? "updated" : "created"}`);
                window.location.href = "/higher-education";
                router.push("/higher-education");
            }
        } catch (err) {
            console.log("[higher-education_POST]", err);
        ...
        <div className="p-10">
            {initialData ? (
                <div className="flex items-center justify-between">
                    <p className="text-heading2-bold">Edit Higher-Education</p>
                    {/* <Delete id={initialData._id} item="higher-education" /> */}
                </div>
            ) : (
                <p className="text-heading2-bold">Higher-Education</p>
            )}
