...
import TeamForm from "@/components/seo-services/SeoForm1";
...
const TeamDetails = () => {
    ...
    const { seoId } = useParams(); // get teamId from useParams

    const getDetails = async () => {
        try {
            const res = await fetch(`/api/seo-services/${seoId}`, {
                method: "GET"
            });
    ...
    const renderForm = () => {
        ...
        const FormComponent = formMapping[seoId as TeamId] || TeamForm;
