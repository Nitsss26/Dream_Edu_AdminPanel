...
import TeamForm from "@/components/writing-service/WritingForm1";
...
const TeamDetails = () => {
    ...
    const { writingId } = useParams(); // get teamId from useParams

    const getDetails = async () => {
        try {
            const res = await fetch(`/api/writing-service/${writingId}`, {
                method: "GET"
            });
    ...
    const renderForm = () => {
        ...
        const FormComponent = formMapping[writingId as TeamId] || TeamForm;
