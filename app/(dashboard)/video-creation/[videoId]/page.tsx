...
import TeamForm from "@/components/video-creation/VideoForm1";
...
const TeamDetails = () => {
    ...
    const { videoId } = useParams(); // get teamId from useParams

    const getDetails = async () => {
        try {
            const res = await fetch(`/api/video-creation/${videoId}`, {
                method: "GET"
            });
    ...
    const renderForm = () => {
        ...
        const FormComponent = formMapping[videoId as TeamId] || TeamForm;
