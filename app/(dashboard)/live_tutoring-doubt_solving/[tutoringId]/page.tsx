...
import TeamForm from "@/components/live_tutoring-doubt_solving/TutoringForm1";
...
const TeamDetails = () => {
    ...
    const { tutoringId } = useParams(); // get teamId from useParams

    const getDetails = async () => {
        try {
            const res = await fetch(`/api/live_tutoring-doubt_solving/${tutoringId}`, {
                method: "GET"
            });
    ...
    const renderForm = () => {
        ...
        const FormComponent = formMapping[tutoringId as TeamId] || TeamForm;
